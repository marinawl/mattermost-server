...
export function sendDesktopNotification(post, msgProps) {
    return async (dispatch, getState) => {
        ...
        if (notify) {
            ...
            dispatch(notifyMe(title, body, channel, teamId, silent, soundName, url, sender));
...
export const notifyMe = (title, body, channel, teamId, silent, soundName, url, sender) => (dispatch) => {
    // handle notifications in desktop app
    if (isDesktopApp()) {
        DesktopApp.dispatchNotification(title, body, channel.id, teamId, silent, soundName, url, sender);
    } else {
        showNotification({
            title,
            body,
